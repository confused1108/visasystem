...
?>
<!DOCTYPE html>
<!-- saved from url=(0080)https://www.evisaonline.org.in/index.php/welcomevisa/form_for_visa_step2/BOL5320 -->
...
<form method="post" action="<?=CTRL?>Visa/apply_second/<?php echo $this->uri->segment('3'); ?>" autocomplete="off" onsubmit="return validate_basic_details_form(3);">
    ...
    <div class="wrapper">
        ...
        <div class="pageHeading1 text_center">
            Applicant Details Form <div style="float:right;margin-right:10px;"> <a href="https://www.evisaonline.org.in/" title="Back To Home"><img src="<?=THEME?>custom/Apply for Visa2_files/Home_2.png"></a> </div>
        </div>
