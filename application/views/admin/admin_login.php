        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                <div class="text-center p-t-20 p-b-20">
                    <span class="db"><img src="<?=THEME?>assets/images/TISS.png" alt="logo" style="width:270px;"/></span>
                </div>
                <!-- Form -->
...
<!--                                    <button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i> Lost password?</button>-->
									...
									<br>
<!--									<a href="--><?//=CTRL?><!--User/login_view"><p style="margin-top:3%;"><u style="color:#ffb848;">Back To User</u></p></a>-->
                                </div>
                            </div>
                        </div>
                    </div>
