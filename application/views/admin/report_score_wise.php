            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <form class="form-horizontal" method="post" action="<?=CTRL?>Admin/get_score_wise_report">
                            <div class="card-body">
                                <h4 class="card-title">Score Wise Report</h4>

                                <div class="form-group row">
                                    <div class="col-sm-9" id="org_show">
                                        <input class="form-control" type="number" min="0" max="100" style="width: 100%; height:36px;" name="low" placeholder="Lower Number">
                                    </div>
                                    <div class="col-sm-9" id="org_show">
                                        <input class="form-control" type="number" min="0" max="100" style="width: 100%; height:36px;" name="high" placeholder="Higher Number">
                                    </div>
