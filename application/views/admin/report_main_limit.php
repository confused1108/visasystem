    ...
    <div class="card">
        ...
        if($type=='genetic') {
            ...
            <div class="container">
                ...
                <br>
                <table class="table table-striped table-bordered" id="example" style="white-space:nowrap;">
                    <thead>
                    <th>Priority</th>
                    <th>Male</th>
                    <th>Female</th>
                    ...
                    for($j=0;$j<$num;$j++) {
                        ...
                        for ($i = 0; $i < 1; $i++) {
                            ?>
                            <tr>
                                <td><?php if($one[$j][$i]['priority']=='value_2') echo "Higher Value"; else echo "Lower Value"; ?></td>
                                <td><?php echo $one[$j][$i]['min']; echo " - ";  echo $one[$j][$i]['max'];  ?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$one[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
                                <td><?php echo $two[$j][$i]['min'];  echo " - ";  echo $two[$j][$i]['max']; ?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$two[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
            ...
            <div class="container">
                <br>
                <table class="table table-striped table-bordered" id="example1" style="white-space:nowrap;">
                    <thead>
                    <th>Priority</th>
                    ...
                    for($j=0;$j<$num1;$j++) {
                        ...
                        for ($i = 0; $i < 1; $i++) {
                            ...
                            <tr>
                                <td><?php if($one[$j][$i]['priority']=='value_2') echo "Higher Value"; else echo "Lower Value"; ?></td>
                                <td>
                                    <?php echo $one[$j][$i]['min']; echo " - ";  echo $one[$j][$i]['max'];?>
                                    <?php
                                        foreach ($history as $var){
                                            if($var['param_id']==$one[$j][$i]['param_id']){
                                                echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                ...
                                <td><?php echo $two[$j][$i]['min']; echo " - ";  echo $two[$j][$i]['max'];?>
                                    ...
                                    ?></td>
                                <td><?php echo $three[$j][$i]['min']; echo " - "; echo $three[$j][$i]['max'];?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$three[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
                                <td><?php echo $four[$j][$i]['min']; echo " - "; echo $four[$j][$i]['max'];?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$four[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
                                <td><?php echo $five[$j][$i]['min']; echo " - "; echo $five[$j][$i]['max']; ?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$five[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
                                <td><?php echo $six[$j][$i]['min']; echo " - "; echo $six[$j][$i]['max']; ?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$six[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
                                <td><?php echo $seven[$j][$i]['min']; echo " - "; echo $seven[$j][$i]['max']; ?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$seven[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
                                <td><?php echo $eight[$j][$i]['min']; echo " - "; echo $eight[$j][$i]['max'];?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$eight[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
            ...
            <div class="container">
                <br>
            <table class="table table-striped table-bordered" id="example2" style="white-space:nowrap;">
                    <thead>
                    <th>Priority</th>
                    <th>Male</th>
                    <th>Female</th>
                    ...
                    for($j=0;$j<$num2;$j++) {
                        ...
                        for ($i = 0; $i < 1; $i++) {
                            ?>
                            <tr>
                                <td><?php if($nine[$j][$i]['priority']=='value_2') echo "Higher Value"; else echo "Lower Value"; ?></td>
                                <td><?php echo $nine[$j][$i]['min']; echo " - ";  echo $nine[$j][$i]['max'];  ?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$nine[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
                                <td><?php echo $ten[$j][$i]['min'];  echo " - ";  echo $nine[$j][$i]['max']; ?>
                                    <?php
                                    foreach ($history as $var){
                                        if($var['param_id']==$ten[$j][$i]['param_id']){
                                            echo "<br>Previous : (".$var['min']." - ".$var['max'].")";
                                        }
                                    }
                                    ?></td>
            ...
            <div class="container">
                <br>
                <table class="table table-striped table-bordered" id="example3" style="white-space:nowrap;">
                    <thead>
                    <th>Priority</th>
                    <th>Male (8-9 Years)</th>
                    <th>Female (8-9 Years)</th>
