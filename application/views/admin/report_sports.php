...
<head>
    ...
    <title>Performance Report (<?php echo $data1[0]['name'];?>)</title>
    <!-- Favicon-->
...
<div class="header">
    <h2 style="text-align:center;">
       Performance Report (<?php echo $data1[0]['name'];?>)

    </h2>
	<?php if($start_date!="" && $end_date!="") {?>
<p style="text-align:center;font-weight:600;color:red;font-size:17px;">(<?php echo $start_date;?> To <?php echo $end_date;?>)</p>
	<?php } ?>
    ...
    <div class="card">
            ...
            <div class="container">
                ...
                <table class="table table-striped table-bordered" id="example" style="width:100%;">
                    ...
                    <tbody>
                    <?php if(isset($msg)){
						echo "<tr><td>No data available</td><td></td><td></td><td></td><td></td><td></td></tr>";
					} else {
                    foreach($data as $val) {
                        ?>
                        <tr>
                            <td style="font-weight: bold;width:20%;"><?php echo $val['name'];?></td>
