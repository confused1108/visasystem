            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                            ...
                            <form class="form-horizontal" method="post" action="<?=CTRL?>Admin/Next_search">
                                <div class="card-body">
                                    <h4 class="card-title">Query Model</h4>

                                    <div class="form-group row">
                                        <label for="userName" class="col-sm-3 text-right control-label col-form-label">Search By</label>
                                       <div class="col-sm-9">
                                                                            <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="search_by">
                                                                                <option value="Select">Select</option>
                                                                               <a href="#"> <option value="Searching Individual">Searching Individual </option></a>
                                                                                <option value="Record of students">Record of students</option>
                                                                                <option value="Record of students Year Wise">Record of students Year Wise</option>
                                                                                <option value="Record of students Game Wise">Record of students Game Wise</option>
                                                                                <option value="Record of students Position Wise">Record of students Position Wise</option>
                                                                                <option value="Record of students Score Wise">Record of students Score Wise</option>
