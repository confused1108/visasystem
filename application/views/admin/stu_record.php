            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                            ...
                            <form class="form-horizontal" method="post" action="<?=CTRL?>Admin/record_student">
                                <div class="card-body">
                                    <h4 class="card-title">Search Individual From</h4>

                                    <div class="form-group row">
                                        <label for="userName" class="col-sm-3 text-right control-label col-form-label"></label>
                                       <div class="col-sm-9">
                                                                        
                                     <label for="customControlValidation2   ">Organisation Wise</label>
									 <input name="searchby" required="" type="radio" value="Organisation_wise" onclick="org_show()">
                                     
									   <label for="customControlValidation2   ">State Wise</label>
									   <input name="searchby" required="" type="radio" value="State_wise" onclick="state_Wise()">
									   
									     <label for="customControlValidation2   ">District Wise</label>
									  <input name="searchby" required="" type="radio" value="District_wise" onclick="District_wise()">
                                                                
                                       </div>
									   
									     
                                      
										 <div class="col-sm-9" id="org_show" style="display:none;">
                                          <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="search_by">
										   <option value="Select">Select</option>
										  <?php foreach($orgdata as $val) 
										  { ?>
                                                                               
                                                                               <a href="#"> <option value="<?php echo $val['org_id'];?>"><?php echo $val['org_name'];?> </option></a>
										  <?php } ?>
                                                                               
                                                                            </select>
                                        </div>
										
										<div class="col-sm-9" id="state_show" style="display:none;">
										
                                          <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="search_state_by">
										   <option value="Select">Select</option>
										  <?php foreach($orgdata as $val) 
										  { ?>
                                                                               
                                                                               <a href="#"> <option value="<?php echo $val['state'];?>"><?php echo $val['state'];?> </option></a>
										  <?php } ?>
                                                                               
                                                                            </select>
                                        </div>
										<div class="col-sm-9" id="dist_show" style="display:none;">
										
                                          <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="search_district_by">
										   <option value="Select">Select</option>
										  <?php foreach($orgdata as $val) 
										  { ?>
                                                                               
                                                                               <a href="#"> <option value="<?php echo $val['district'];?>"><?php echo $val['district'];?> </option></a>
										  <?php } ?>
