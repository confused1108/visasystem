            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <form class="form-horizontal" method="post" action="<?=CTRL?>Admin/get_year_wise_report">
                            <div class="card-body">
                                <h4 class="card-title">Year Wise Report</h4>

                                <div class="form-group row">
                                    <div class="col-sm-9" id="org_show">
                                        <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="search_by_year">
                                            <option value="Select">Select</option>
                                            <?php foreach($data as $val)
                                            { ?>

                                                <a href="#"> <option value="<?php echo $val['year'];?>"><?php echo $val['year'];?> </option></a>
                                            <?php } ?>
