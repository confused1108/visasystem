            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                            ...
                            <form class="form-horizontal" method="post" action="<?=CTRL?>Admin/student_report">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <label for="customControlValidation2   ">Name</label>
									 <input name="searchby" required="" type="radio" value="Name" onclick="show_name()">
                                     
									   <label for="customControlValidation2   ">Id</label>
									   <input name="searchby" required="" type="radio" value="Id" onclick="show_id()">
										 ...
										 <div class="col-sm-9">
                                            <input type="text" class="form-control" id="search_name"
                                                   value="" name="search_Name" placeholder="Enter Name" style="display:none;" >
                                        </div>
										 <div class="col-sm-9">
